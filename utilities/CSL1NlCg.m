function [x, f1, L2Obj, L1Obj, finalcost] = CSL1NlCg(x0,param)
% 
% res = CSL1NlCg(param)
%
...
while(1)
	...
	[f0,L2Obj, L1Obj] = objective(x,dx,0,param);
	t = t0;
    [f1,L2Obj, L1Obj] = objective(x,dx,t,param);
	lsiter = 0;
	while (f1 > f0 - alpha*t*abs(g0(:)'*dx(:)))^2 & (lsiter<maxlsiter)
		lsiter = lsiter + 1;
		t = t * beta;
		[f1, L2Obj, L1Obj] = objective(x,dx,t,param);
        [finalcost] = [finalcost,f1];
	end
...
function [res, L2Obj, L1Obj] = objective(x,dx,t,param) %**********************************
